...
TOOL_OPERATIONS: dict[str, str | None] = {
    ...
    "file.create_upload_part_urls": "file.create_upload_part_urls",
    "file.create_version_upload": "file.create_version_upload",
    "file.switch_current_version": "file.switch_current_version",
